...
public class MyRestaurantListAdapter extends ArrayAdapter<Restaurant>{
	List <Restaurant> myResturants;
	private Context context;
	private LayoutInflater vi;

	public MyRestaurantListAdapter(Context context, List<Restaurant> myResturants ) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if(itemView == null)
		{
			...
			itemView = vi.inflate(R.layout.resturant_item_view, parent,false);
		...
		TextView distance = (TextView)itemView.findViewById(R.id.restdistance);
		
		DecimalFormat df = new DecimalFormat();      
		distance.setText(String.valueOf(df.format(Rest.getDistance_in_km())) + " KM");
